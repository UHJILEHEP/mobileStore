$(function () {
    ...
    $("#products-form input[data-type=file], #products-form input[data-type=image]").on("change",function(){
      $(this).data("uploadedfiles",[]);    
    });
    var apikey = "6779d251f0549d1bfa8d2fa6"; // TODO: INSERT YOUR CORS API KEY HERE OR add formapikey to settings
    ...
    var ajaxSettings = {
      "async": true,
      "crossDomain": true,
      "url": "https://webmiddle-2e4b.restdb.io/rest/products",
      "method": "POST",
      "headers": {
        "x-apikey": apikey,
    ...
    var ajaxSettingsAttachments = {
       "async": true,
       "url": "https://webmiddle-2e4b.restdb.io/media",
       "method": "POST",
       "contentType": false,
       "headers": {
         "x-apikey": apikey
    ...
    function postForm() {
      ...
      // clear errors
      $("#products-form .has-error").removeClass("has-error");
      $("#products-form .help-block").remove();
   ...
   // get the form data
      var formObj = $("#products-form").serializeObject();
  
      // get attachments from inputs
      var attachments = [];
  
      $("#products-form input[data-type=file], #products-form input[data-type=image]").each(function(input){
        ...
        .done(function(){
         ...
         ajaxSettings.data = JSON.stringify(formObj);
          ...
          .done(function (response) {
            ...
            $("#products-form").replaceWith("<div class='thank-you'>"+successMessage+"</div>");
          })
